...
public class BoxInteraction2 : MonoBehaviour
{
    ...
    {
        npc1Text.text = "This must be the controllor of the Death Cannons.";
    ...
    {
        npc1Text.text = "Great! Cannons are shut down. Time to save the innocences at bottom!";
