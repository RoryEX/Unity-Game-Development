...
public class PlayerController : MonoBehaviour
{
    ...
    public AudioSource lightATK;
    public AudioSource heavtAtk;
    public AudioSource jumpSFX;
    public AudioSource kunaiSFX;
    ...
    private void OnCollisionEnter2D(Collision2D other)
    {
        ...
        {
            bossDown = targetBoss.GetComponent<NeueZielAI>().isDead;
            if (bossDown)
            {
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if (other.name == "TimeBox40")
        {
            LV2GM.GetComponent<LV2GameMangent>().timer += 40;
            Destroy(other.gameObject);
            pickUp.Play();
        }
        else if (other.name == "TimerBox20")
        {
            LV2GM.GetComponent<LV2GameMangent>().timer += 20;
            Destroy(other.gameObject);
            pickUp.Play();
        }
    }
